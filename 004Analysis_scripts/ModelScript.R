...
transects<-read.csv("C:/Users/hmfertel.CAMPUS/Documents/Stephens Lab/Non-Con_Severity/ShrubSeverity/002Data/TransectInfo.csv")
Posts<-read.csv("C:/Users/hmfertel.CAMPUS/Documents/Stephens Lab/Non-Con_Severity/002Data/HoplandGPS.csv")
